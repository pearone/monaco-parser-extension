 ...
 */
globalWmStatement: (enable | disable) KW_WORKLOAD KW_MANAGEMENT;
...
poolPath: identifier (DOT identifier)*;
...
createTriggerStatement:
	KW_CREATE KW_TRIGGER identifier DOT identifier KW_WHEN triggerExpression KW_DO
...
dropPoolStatement: KW_DROP KW_POOL identifier DOT poolPath;
