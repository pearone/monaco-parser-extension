...
import IdentifiersParser, HiveParser;
...
lateralView:
	...
	| COMMA? KW_LATERAL KW_VIEW function_ tableAlias (
		KW_AS identifier (COMMA identifier)*
	)?
...
tableName: identifier DOT identifier | identifier;

viewName: (identifier DOT)? identifier;
